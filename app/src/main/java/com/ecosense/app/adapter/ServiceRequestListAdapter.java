...
public class ServiceRequestListAdapter extends RecyclerView.Adapter {
    ...
    public ServiceRequestListAdapter(Context context, List<Complaints> complaintsList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == EMPTY_VIEW) {
            ...
            itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_service_request_list_row, parent, false);
...
//            ((MyViewHolder) holder).tv_com_emailId.setText(complaintsItem.getEmailId());
                ...
                if (complaintsItem.getDriver_name() == null) {
                    ((MyViewHolder) holder).tv_com_assign.setText(context.getString(R.string.na_tag));
                } else {
...
//                        .into(((MyViewHolder) holder).);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView tv_esta_name,tv_complainNo, tv_com_date_time, tv_complain_title, tv_psName, tv_com_assign, tv_com_Mno, tv_com_emailId;
