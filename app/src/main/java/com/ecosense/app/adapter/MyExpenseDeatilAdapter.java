...
public class MyExpenseDeatilAdapter extends RecyclerView.Adapter {
    ...
    public MyExpenseDeatilAdapter(Context context, List<Expense> expenseList, String className) {
