...
public class GooglePositionProvider extends PositionProvider {
    ...
    public void startUpdates() {
        ...
        locationRequest.setPriority(getPriority(Objects.requireNonNull(preferences.getString(AppConfig.KEY_ACCURACY, "medium"))));
        locationRequest.setInterval(distance > 0 || angle > 0 ? MINIMUM_INTERVAL : interval);
        locationRequest.setFastestInterval(1000);
//        Log.e("GooglePositionProvider", " distance = " + distance);
//        Log.e("GooglePositionProvider", " angle = " + angle);
//        Log.e("GooglePositionProvider", " MINIMUM_INTERVAL = " + MINIMUM_INTERVAL);
//        Log.e("GooglePositionProvider", " interval = " + interval);
//        Log.e("GooglePositionProvider", "Calaculate Loc Interval = " + (distance > 0 || angle > 0 ? MINIMUM_INTERVAL : interval));
