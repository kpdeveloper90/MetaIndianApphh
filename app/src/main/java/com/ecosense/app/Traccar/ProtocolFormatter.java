...
public class ProtocolFormatter {
    ...
    public static String formatRequest(String url, Position position, String alarm) {
        ...
        Uri.Builder builder = serverUrl.buildUpon()
                ...
                .appendQueryParameter("address", String.valueOf(position.getAddress()))
                .appendQueryParameter("userid", String.valueOf(position.getUserid()))
                .appendQueryParameter("position_type", String.valueOf(position.getPosition_type()))
