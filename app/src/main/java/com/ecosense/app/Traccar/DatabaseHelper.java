...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void insertPosition(Position position) {
        ...
        values.put("position_type", position.getPosition_type());
    ...
    public Position selectPosition() {
        ...
        try {
            if (cursor.getCount() > 0) {
                ...
                position.setAddress(cursor.getString(cursor.getColumnIndex("address")));
                position.setUserid(cursor.getString(cursor.getColumnIndex("userid")));
                position.setPosition_type(cursor.getString(cursor.getColumnIndex("position_type")));
