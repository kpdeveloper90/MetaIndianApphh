...
public class Position {
    ...
    public Position(String deviceId, Location location, double battery,String address,String userid,String position_type) {
        this.deviceId = deviceId;
        ...
        longitude = location.getLongitude();
        altitude = location.getAltitude();
        speed = location.getSpeed() * 3.6; // speed in km/hr
        course = location.getBearing();
        if (location.getProvider() != null && !location.getProvider().equals(LocationManager.GPS_PROVIDER)) {
            accuracy = location.getAccuracy();
        }
