...
public class MyPOICollected extends AppCompatActivity implements ItemClickListener, SearchView.OnQueryTextListener, SwipeRefreshLayout.OnRefreshListener, View.OnClickListener, ConnectionReceiver.ConnectionReceiverListener {

    private static final String TAG = MyPOICollected.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_poicollected);

        ButterKnife.bind(this);
        toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("My Collected POI");
...
//                        previous_Item_Total = totalItemCount;
                        ...
                        getAssetsBinDetailOnServer(wardNo, totalItemCount);
                        isLoading = true;
...
//        dialog_wardNumberDetailConform();
        ...
        getAssetsBinDetailOnServer(wardNo, 0);
    ...
    public void getwardNoListOnServer() {
        ...
        if (!isConnected) {
            ...
            mProgressDialog = new ProgressDialog(MyPOICollected.this);
...
//                        mProgressDialog = null;
    ...
    public void getAssetsBinDetailOnServer(String wardNumber, int request_limit_start) {
        isConnected = checkConnection();
        if (!isConnected) {
            Log.e(TAG, " Not connected ");
            TastyToast.makeText(getApplicationContext(),  getString(R.string.no_internet_alert), TastyToast.LENGTH_LONG, TastyToast.ERROR);
...
//                            + "\"]]]";
                    ...
                    String url = session.getMyServerIP() + "/api/resource/Asset?filters=" + URLEncoder.encode(filters, "UTF-8") + "&fields=" + fields + "&limit_page_length=" + limit_page_length + "&order_by=creation desc"+ "&limit_start=" + limit_start;
