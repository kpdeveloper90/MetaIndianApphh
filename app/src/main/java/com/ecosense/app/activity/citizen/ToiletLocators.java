...
import com.ecosense.app.adapter.ToilateLocatorAdapter;
...
public class ToiletLocators extends AppCompatActivity implements OnMapReadyCallback,
        GoogleApiClient.OnConnectionFailedListener, View.OnClickListener, ConnectionReceiver.ConnectionReceiverListener {
    private static final String TAG = ToiletLocators.class.getSimpleName();
...
//        Toast.makeText(this, "Map is Ready", Toast.LENGTH_SHORT).show();
    ...
    //widgets
    private androidx.appcompat.widget.AppCompatAutoCompleteTextView mSearchText;
...
//            | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION
    ...
    ArrayList<Assets> assetsTrackersList = null;
    ToilateLocatorAdapter toilateLocatorAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toilet_locators);
        ...
        mSearchText = (androidx.appcompat.widget.AppCompatAutoCompleteTextView) findViewById(R.id.input_search);
        mGps = (ImageView) findViewById(R.id.ic_gps);

        Log.e(TAG, "Init" + assetsTrackersList.size());
//        toilateLocatorAdapter = new ToilateLocatorAdapter(getApplicationContext(), R.layout.rv_place_type_list_row, assetsTrackersList);
//        mSearchText.setThreshold(1);
//        mSearchText.setAdapter(toilateLocatorAdapter);
//
//// handle click event and set desc on textview
//        mSearchText.setOnItemClickListener(new AdapterView.OnItemClickListener() {
//            @Override
//            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
//                Assets as = (Assets) adapterView.getItemAtPosition(i);
//                Log.e(TAG,""+as.getFalocation());
//            }
//        });
    ...
    //    public void getAssetsBinDetailOnServer(String assatsName, LatLng latLng, float zoom, String title) {
    public void getAssetsBinDetailOnServer() {
        isConnected = checkConnection();
        if (!isConnected) {
            ...
            mProgressDialog = new ProgressDialog(ToiletLocators.this);
            ...
            new android.os.Handler().postDelayed(() -> {
                try {
                    ...
                    filters = "[[\"Asset\",\"item_code\",\"in\",[\"Toilet\""
                            + "]],[\"Asset\",\"status\",\"in\",[\""
                            + AppConfig.BIN_Status_Submitted
                            + "\"]]]";
//                    filters = URLEncoder.encode("[[\"Asset\", \"type_of_item\", \"=\",\"", "UTF-8")
//                            + assatsName
...
//                                                moveCamera(latLng, zoom, title);
                                                    if (eventDetails.getFalatitude() != null || eventDetails.getFalongitude() != null) {
                                                        Log.e(TAG, "getFalatitude = " + eventDetails.getFalatitude() + "\t getFalongitude = " + eventDetails.getFalongitude());
                                                        mMap.addMarker(new MarkerOptions()
                                                                .position(new LatLng(Double.parseDouble(eventDetails.getFalatitude()), Double.parseDouble(eventDetails.getFalongitude())))
                                                                .title(eventDetails.getAsset_name())
                                                                .snippet(eventDetails.getFalocation())
                                                        );
                                                    }else{
                                                        Log.e(TAG,"NOt Find LAt,LONG getAsset_Id() = " + eventDetails.getAsset_Id()+ "= , getFalatitude & getFalongitude not avalable = ");
                                                    }
                                                }
                                            }
...
//                Log.d(TAG, "onResult: attributions: " + place.getAttributions());
    ...
    private void geoLocate() {
        ...
        Geocoder geocoder = new Geocoder(ToiletLocators.this);
        ...
        if (list.size() > 0) {
            ...
            moveCamera(new LatLng(address.getLatitude(), address.getLongitude()), DEFAULT_ZOOM,
                    address.getAddressLine(0));
//            getAssetsBinDetailOnServer("Toilet", new LatLng(address.getLatitude(), address.getLongitude()),
//                    DEFAULT_ZOOM,
//                    address.getAddressLine(0));
                ...
                location.addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        moveCamera(new LatLng(currentLocation.getLatitude(), currentLocation.getLongitude()),
                                DEFAULT_ZOOM,
                                "My Location");
//                        getAssetsBinDetailOnServer("Toilet", new LatLng(currentLocation.getLatitude(), currentLocation.getLongitude()),
//                                DEFAULT_ZOOM,
//                                "My Location");
                    } else {
                        Log.d(TAG, "onComplete: current location is null");
                        Toast.makeText(ToiletLocators.this, getString(R.string.unable_to_get_current_location), Toast.LENGTH_SHORT).show();
                    }
                });
            }
...
//        mMap.clear();
        ...
        mMap.setInfoWindowAdapter(new CustomInfoWindowAdapter(ToiletLocators.this));
...
//                mMarker = mMap.addMarker(options);
    ...
    private void moveCamera(LatLng latLng, float zoom, String title) {
        Log.d(TAG, "moveCamera: moving the camera to: lat: " + latLng.latitude + ", lng: " + latLng.longitude);
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, zoom));
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(latLng.latitude, latLng.longitude), 10));
...
//        for (int i = 0; i < assetsTrackersList.size(); i++) {
//            Assets as = assetsTrackersList.get(i);
////            Log.e(TAG, "getFalatitude = " + as.getFalatitude() + "\t getFalongitude = " + as.getFalongitude());
//            mMap.addMarker(new MarkerOptions()
//                    .position(new LatLng(Double.parseDouble(as.getFalatitude()), Double.parseDouble(as.getFalongitude())))
//                    .title(as.getFalocation())
//            );
//        }
    ...
    private void initMap() {
        ...
        mapFragment.getMapAsync(ToiletLocators.this);
    }
